...
//CAN错误码
#define	ERR_CAN_OVERFLOW	0x0001		0x0001	//CAN控制器内部FIFO溢出
...
EXTERNC DLL_EXPORT DWORD VCI_InitCAN(DWORD DeviceType, DWORD DeviceInd, DWORD CANInd, PVCI_INIT_CONFIG pInitConfig);
